        ...
        <div class="w-64 bg-white shadow-lg flex flex-col fixed h-full">
            ...
            <div class="flex-1 overflow-y-auto p-4">
                <div class="mb-6">
                    ...
                    <div class="space-y-1">
                        <Link :href="route('dashboard.index')" class="flex items-center px-3 py-2 text-sm rounded-lg bg-blue-50 text-blue-700">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                            Dashboard
                        </Link>
                        <Link :href="route('dashboard.finance')" class="flex items-center px-3 py-2 text-sm rounded-lg text-gray-700 hover:bg-gray-100">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Keuangan / SPP
                        </Link>
                        <Link :href="route('dashboard.classes')" class="flex items-center px-3 py-2 text-sm rounded-lg text-gray-700 hover:bg-gray-100">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
