...
// Ambil URL saat ini untuk menentukan menu aktif
...
const headerTitle = computed(() => {
    ...
    } else if (url === '/dashboard/finance' || url.startsWith('/dashboard/finance/')) {
        return 'Keuangan / SPP';
    } else if (url === '/dashboard/classes' || url.startsWith('/dashboard/classes/')) {
        return 'Data Kelas';
    } else if (url === '/dashboard/santri' || url.startsWith('/dashboard/santri/')) {
        return 'Data Santri';
    } else if (url === '/dashboard/guru' || url.startsWith('/dashboard/guru/')) {
        return 'Data Guru';
    } else {
        return 'Dashboard Utama';
    }
            ...
            <div class="flex-1 overflow-y-auto p-4">
                <div class="mb-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <Link :href="route('dashboard.finance')" 
                              class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors"
                              :class="isActive('/dashboard/finance') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-1">
                        <Link :href="route('dashboard.santri')" 
                              class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors"
                              :class="isActive('/dashboard/santri') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <Link :href="route('dashboard.guru')" 
                              class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors"
                              :class="isActive('/dashboard/guru') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            Data Guru
                        </Link>
                        <Link :href="route('dashboard.classes')" 
                              class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors"
                              :class="isActive('/dashboard/classes') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
