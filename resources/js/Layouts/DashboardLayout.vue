...
// Fungsi untuk cek apakah menu aktif - diperbaiki
const isActive = (url) => {
    // Jika URL yang dicek adalah dashboard utama
    if (url === '/dashboard') {
        // Aktif hanya jika persis sama dengan '/dashboard'
        return currentUrl.value === '/dashboard';
    }
    // Untuk menu lain, cek apakah URL saat ini sama persis atau dimulai dengan url + '/'
...
const headerTitle = computed(() => {
    ...
    if (url === '/dashboard') {
        ...
        return 'Data Kelas';
    } else if (url.includes('/dashboard/santri')) {
        return 'Data Santri';
    } else {
        return 'Dashboard Utama';
    }
